/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0791e8e99d151d30335205433fb1fc3)
// Runtime types generated with workerd@1.20250617.0 2025-06-17
declare namespace Cloudflare {
	interface Env {
		PUBLIC_TRPC_URL: 'http://localhost:8787/trpc' | 'https://api.pollmodoro.com/trpc';
		PUBLIC_WEBSOCKET_URL: 'ws://localhost:8787/websocket' | 'wss://api.pollmodoro.com/websocket';
		PUBLIC_TURNSTILE_SITE_KEY: '1x00000000000000000000AA' | '0x4AAAAAABkRrcGkRXf88Sft';
		ASSETS: Fetcher;
	}
}
