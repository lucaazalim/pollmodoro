...
<div class="mx-auto max-w-3xl p-6">
  ...
  {:else if $pollStore.error}
    <div
      class="bg-destructive/10 border-destructive/20 rounded-lg border p-6 text-center"
    >
      <h2 class="text-destructive mb-2 text-xl font-semibold">
        Error Loading Poll
      </h2>
      <p class="text-destructive/80">{$pollStore.error}</p>
      <Button onclick={loadPoll} variant="destructive" class="mt-4"
        >Try Again</Button
      >
    </div>
      ...
      <div class="p-6">
        ...
        <div class="mt-6">
          ...
          >
            ...
            {:else}
              Submit Vote{poll.allowMultipleOptions &&
        ...
        {#if $voteStore.error}
          <div
            class="bg-destructive/10 border-destructive/20 mt-4 rounded-lg border p-3"
          >
        ...
        {#if $voteStore.data}
          <div
            class="mt-4 rounded-lg border border-green-500/20 bg-green-500/10 p-3"
          >
